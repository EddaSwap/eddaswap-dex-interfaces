...
import * as BSC_SDK from '@eddaswap/sdk';
import * as BSC_SDK_v2 from '@eddaswap/sdk-v2';
import * as POLYGON_SDK from '@eddaswap/sdk-polygon';
...
export const SDK = {
  [ChainId.BSC]: BSC_SDK,
  [ChainId.MATIC]: POLYGON_SDK,
};

export const SDK_v2 = {
  [ChainId.BSC]: BSC_SDK_v2,
  [ChainId.MATIC]: POLYGON_SDK,
};
...
export const ETHER = {
  [ChainId.BSC]: BSC_SDK.ETHER,
  [ChainId.MATIC]: POLYGON_SDK.ETHER,
};
export const WETH = {
  [ChainId.BSC]: BSC_SDK.WETH[ChainId.BSC],
  [ChainId.MATIC]: POLYGON_SDK.WETH[ChainId.MATIC],
};
...
export const SupportedTokens = {
  ...
  [ChainId.MATIC]: polygonTokens.map(
    (item) =>
      new POLYGON_SDK.Token(
        item.chainId,
        item.address,
        item.decimals,
        item.symbol,
...
export const tokensLogoURL = {
  BNB: 'https://assets.coingecko.com/coins/images/825/small/binance-coin-logo.png?1547034615',
  WBNB: 'https://assets.coingecko.com/coins/images/825/small/binance-coin-logo.png?1547034615',
  BUSD: 'https://assets.coingecko.com/coins/images/9576/small/BUSD.png?1568947766',
  BAKE: 'https://assets.coingecko.com/coins/images/12588/small/bakerytoken_logo.jpg?1600940032',
  BDO: 'https://assets.coingecko.com/coins/images/13487/small/bdollar-yellow.png?1609291587',
  BETH: 'https://raw.githubusercontent.com/trustwallet/assets/master/blockchains/smartchain/assets/0x250632378E573c6Be1AC2f97Fcdf00515d0Aa91B/logo.png',
  ...
  DOT: 'https://assets.coingecko.com/coins/images/12171/small/aJGBjJFU_400x400.jpg?1597804776',
  ...
  DAI: 'https://raw.githubusercontent.com/trustwallet/assets/master/blockchains/smartchain/assets/0x1AF3F329e8BE154074D8769D1FFa4eE058B1DBc3/logo.png',
  HOTCROSS:
    'https://raw.githubusercontent.com/trustwallet/assets/master/blockchains/smartchain/assets/0x4FA7163E153419E0E1064e418dd7A99314Ed27b6/logo.png',
  ...
  TUSD: 'https://assets.coingecko.com/coins/images/3449/small/tusd.png?1618395665',
};

// DefaultToken: when user pick same on both side, change one of them to DefaultToken
...
// TODO: multiple chain
export const WBNB = BSC_SDK.WETH[56];

const WETH_ONLY = {
  [ChainId.BSC]: [BSC_SDK.WETH[ChainId.BSC]],
  [ChainId.BSC_TESTNET]: [BSC_SDK.WETH[ChainId.BSC_TESTNET]],
  [ChainId.MATIC]: [POLYGON_SDK.WETH[ChainId.MATIC]],
};
...
export const getTokenLogoURL = (address) => {
  ...
  let bscToken = bscTokens.find(
    (item) => item.address.toLowerCase() === address.toLowerCase()
  );
  if (bscToken) return bscToken.logoURI;

  let polygonToken = polygonTokens.find(
    (item) => item.address.toLowerCase() === address.toLowerCase()
  );
  if (polygonToken) return polygonToken.logoURI;

  const maticTokenLogo = getMaticTokenLogoURL(address);
  if (maticTokenLogo) return maticTokenLogo;
  return '';
};
